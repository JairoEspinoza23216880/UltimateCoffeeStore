...
public class SpoiledProgram {
     ...
     * @param discount
     */
    public SpoiledProgram(String name, String benefit, double discount) {
    ...
    /*
     * Metodo setCustomerList
     * Metodo que establece la lista de clientes
     * @param customer_list Lista de clientes
     */
    public void setCustomerList(ArrayList<Customer> customer_list) {
